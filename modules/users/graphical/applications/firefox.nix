...
let
  ...
  firefoxPkg = if cfg.firefox.useDevEdition then
    ...
    })
    {
      ...
      programs.firefox = {
        ...
        package = pkgs.wrapFirefox firefoxPkg {
          ...
          # Wait for vhdcoapp to be packaged in nix: https://github.com/NixOS/nixpkgs/pull/300051
          # nur repo hasn't been update in months so cant fetch anymore
        ...
        profiles = {
          personal = {
            ...
            extensions = with pkgs.nur.repos.rycee.firefox-addons;
              let
                firefoxTheme = if (config.jd.graphical.theme == "arc-dark") then
                  (buildFirefoxXpiAddon {
                    pname = "arc-dark-theme-firefox";
                    addonId = "arc-dark-theme@afnankhan";
                    version = "2021.6.2";
                    url =
                      "https://addons.mozilla.org/firefox/downloads/file/3786185/arc_dark_theme-2021.6.2-an+fx.xpi";
                  ...
                  (buildFirefoxXpiAddon {
                    ...
                    version = "1.0";
                    url =
                      "https://addons.mozilla.org/firefox/downloads/file/3860526/materia_gtk_dark-1.0.xpi";
              ...
              in [
                ...
                (buildFirefoxXpiAddon {
                  ...
                  version = "0.3.3";
                  url =
                    "https://addons.mozilla.org/firefox/downloads/file/4144699/kagi_search_for_firefox-0.3.3.xpi";
                  sha256 =
                    "0hcw172sj4x4kawqfcxzgzdrrcivp6v6r84vxcykxd3b4nd0b2p2";
                ...
                (buildFirefoxXpiAddon {
                  ...
                  sha256 =
                    "sha256-3OPw5oVD5kqX9mnxVOm5pEWSKNiqJVx8whh/bEuremE=";
                ...
                (buildFirefoxXpiAddon {
                  ...
                  sha256 =
                    "sha256-h8h1hXim3d9y+Anze3ENz1dAneNXywINwcGXRieGl0U=";
              ...
              ++ optional config.jd.applications.activitywatch.enable
              aw-watcher-web;
            userChrome = ''
            ...
            settings = let
              newTab =
                let activityStream = "browser.newtabpage.activity-stream";
                in {
